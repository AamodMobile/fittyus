...
class _DietAndNutritionScreenState extends State<DietAndNutritionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    userController.viewProfileModel.value.community!.length,
    (index) => 0);
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: userController.viewProfileModel.value
                                        .profileBackCover !=
                                        null &&
                                        userController.viewProfileModel.value
                                            .profileBackCover !=
                                            ""
                                        ? CachedNetworkImage(
                                  ...
                                  userController.viewProfileModel.value.id ==
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        userController.pickImage(
                                            context, "cover",  userController.user.value.id.toString());
                                      },
                                      child: Container(
                                        height: 24,
                                        width: 29,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              Get.to(() =>
                                                  GalleryScreen(id: userController.user.value.id.toString()));
                                            },
                                            child: SizedBox(
                                              child: Image.asset(
                                                openGallery,
                                          ...
                                          userController
                                            ...
                                            onTap: () {
                                              ...
                                              userController.user.value.id.toString())
                                                  .then((value) =>
                                                  cont.viewProfile(
    userController.user.value.id.toString(), false));
                                            },
                                            child: Container(
                                              height: 32,
                                              width: 90,
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(
                                height: 80,
                                width: MediaQuery.of(context).size.width,
                                child: cont.viewProfileModel.value.followersList!
                                    .isEmpty
                                    ? Align(
                                  ...
                                  child: Text(
                                    ...
                                    : ListView.builder(
                                    itemCount: cont.viewProfileModel.value
                        ...
                        cont.viewProfileModel.value.community!.isEmpty
                          ...
                          child: ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount:
                            cont.viewProfileModel.value.community!.length,
                            itemBuilder: (BuildContext context, int index) {
                              return myCommunityListTile(
                                  cont.viewProfileModel.value
                                      .community![index],
                                  index);
                            },
  ...
  myCommunityListTile(Community list, int listIndex) {
    var dateOk = list.comments!.isNotEmpty
        ? dateSetOk(list.comments![0].createdAt.toString())
        : "";
    return InkWell(
      onTap: () {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: whiteColor, borderRadius: BorderRadius.circular(2)),
        child: Column(
          children: [
            Padding(
                ...
                children: [
                        ...
                        child: SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: list.communityImages!.isNotEmpty
                              ...
                              fit: BoxFit.contain,
                              imageUrl: ApiUrl.imageBaseUrl +
                                  list.communityImages![ind].image
                                      .toString(),
                              placeholder: (a, b) => const Center(
                                child: CircularProgressIndicator(
                                  color: mainColor,
                  ...
                  list.userId.toString() ==
                    ...
                    child: InkWell(
                      onTap: () {
                        controller
                            .deleteCommunity(list.id.toString())
                            .then((value) => userController.viewProfile(
                            userController.user.value.id.toString(), false));
                      },
                      child: Container(
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: () {
                    controller.communityLike(list.id.toString(),
                        list.isLike.toString() == "0" ? "1" : "0").then((value){
                      Get.find<UserController>().viewProfile(userController.user.value.id.toString(), true).then((value) {
                        controller.isLoading.value= true;
                        indices = List.generate(
                            userController.viewProfileModel.value.community!.length,
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: list.comments![0].userImage != null &&
                                list.comments![0].userImage != ""
                                ? CachedNetworkImage(
                              errorWidget: (context, url, error) =>
                                  Image.asset(
                                    defaultUser,
                        ...
                        Expanded(
                          child: Container(
                            ...
                            decoration:
                            const BoxDecoration(color: grayNew),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Row(
